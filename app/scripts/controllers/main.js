...
angular.module('budgetTrackingApp').controller('MainCtrl', 
  ['$scope', 'ShopService', 'HeadService', 'RequisitionService', 'POService', 
    function ($scope, ShopService, HeadService, RequisitionService, POService) {  
      $scope.shop = ShopService.getSelectedShop()       
      loadShopData($scope, HeadService, RequisitionService, POService)
      ...
      $scope.openHead = function(head){
        if($scope.activeHead == head){
          ...
          HeadService.setActiveHead($scope.activeHead)
        }
      }
}])
...
function loadShopData($scope, HeadService, RequisitionService, POService){
